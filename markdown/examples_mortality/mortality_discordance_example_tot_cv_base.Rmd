---
title: "Mortality: Discordant predictions related to total variation with base biological cv and base analytical cv"
...
parameters$analytical_cv <- variables$analytical_cv_percent[variables$uncertain_variables_indicator]
...
parameters$path_and_name_aggregate_results <- 'out/mortality/simulations_discordance_aggregate_results/mortality_discordance_validation_extern_tot_cv_base.csv'
parameters$path_and_name_stats_with_ci <- 'out/mortality/simulations_discordance_aggregate_results/mortality_discordance_validation_extern_tot_cv_base_stats_with_ci.csv'
```
