---
title: "Mortality: Discordant predictions related to analytical variation with 4x base analytical cv"
...
parameters$path_and_name_aggregate_results <- 'out/mortality/simulations_discordance_aggregate_results/mortality_discordance_validation_extern_an_cv_4.csv'
parameters$path_and_name_stats_with_ci <- 'out/mortality/simulations_discordance_aggregate_results/mortality_discordance_validation_extern_an_cv_4_stats_with_ci.csv'
```
