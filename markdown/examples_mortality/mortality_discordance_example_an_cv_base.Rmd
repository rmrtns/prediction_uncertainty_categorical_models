---
title: "Mortality: Discordant predictions related to analytical variation with base analytical cv"
...
parameters$path_and_name_aggregate_results <- 'out/mortality/simulations_discordance_aggregate_results/mortality_discordance_validation_extern_an_cv_base.csv'
parameters$path_and_name_stats_with_ci <- 'out/mortality/simulations_discordance_aggregate_results/mortality_discordance_validation_extern_an_cv_base_stats_with_ci.csv'
```
