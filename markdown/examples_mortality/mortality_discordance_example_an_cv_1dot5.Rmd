---
title: "Mortality: Discordant predictions related to analytical variation with 1.5x base analytical cv"
...
parameters$path_and_name_aggregate_results <- 'out/mortality/simulations_discordance_aggregate_results/mortality_discordance_validation_extern_an_cv_1dot5.csv'
parameters$path_and_name_stats_with_ci <- 'out/mortality/simulations_discordance_aggregate_results/mortality_discordance_validation_extern_an_cv_1dot5_stats_with_ci.csv'
```
