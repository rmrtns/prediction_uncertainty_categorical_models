---
title: "eGFR: Discordant predictions related to biological variation with base biological cv"
...
parameters$path_and_name_aggregate_results <- 'out/egfr/simulations_discordance_aggregate_results/egfr_discordance_validation_extern_bio_cv_base.csv'
parameters$path_and_name_stats_with_ci <- 'out/egfr/simulations_discordance_aggregate_results/egfr_discordance_validation_extern_bio_cv_base_stats_with_ci.csv'
```
