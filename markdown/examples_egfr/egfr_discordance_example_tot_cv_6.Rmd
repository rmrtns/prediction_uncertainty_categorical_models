---
title: "eGFR: Discordant predictions related to total variation with base biological cv and 6x base analytical cv"
...
parameters$path_and_name_aggregate_results <- 'out/egfr/simulations_discordance_aggregate_results/egfr_discordance_validation_extern_tot_cv_6.csv'
parameters$path_and_name_stats_with_ci <- 'out/egfr/simulations_discordance_aggregate_results/egfr_discordance_validation_extern_tot_cv_6_stats_with_ci.csv'
```
