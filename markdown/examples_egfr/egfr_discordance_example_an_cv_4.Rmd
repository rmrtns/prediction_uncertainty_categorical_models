---
title: "eGFR: Discordant predictions related to analytical variation with 4x base analytical cv"
...
parameters$path_and_name_aggregate_results <- 'out/egfr/simulations_discordance_aggregate_results/egfr_discordance_validation_extern_an_cv_4.csv'
parameters$path_and_name_stats_with_ci <- 'out/egfr/simulations_discordance_aggregate_results/egfr_discordance_validation_extern_an_cv_4_stats_with_ci.csv'
```
