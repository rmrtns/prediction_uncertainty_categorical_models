---
title: "eGFR: Discordant predictions related to total variation with base biological cv and base analytical cv"
...
parameters$analytical_cv <- variables$analytical_cv_percent_egfr[variables$uncertain_variables_indicator_egfr]
...
parameters$path_and_name_aggregate_results <- 'out/egfr/simulations_discordance_aggregate_results/egfr_discordance_validation_extern_tot_cv_base.csv'
parameters$path_and_name_stats_with_ci <- 'out/egfr/simulations_discordance_aggregate_results/egfr_discordance_validation_extern_tot_cv_base_stats_with_ci.csv'
```
